...
import com.eletra.business.dto.ReceivedMessageDTO;
import com.eletra.business.dto.SentMessageDTO;
...
public class ModifiJson {
    ...
    public void execute(String json, UUID ticketId) throws Exception {
